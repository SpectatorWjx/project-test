package com.wjx.sjsr.service.jpa_abstract;
...
import com.wjx.sjsr.repository.BaseJpa;
...
public class AbstractServiceImpl<E extends BaseEntity, J extends BaseJpa<E>> implements AbstractService<E> {
    ...
    public List<E> findAllWhere(E example) {
        List<E> list = jpa.findAll(getWhere(example));
        em.clear();
        return list;
    }
    ...
    protected void setMonthStartAndEnd(E e, String monthDate){
        ...
        Optional.ofNullable(measureTime).orElseThrow(() -> new RuntimeException("时间格式错误"));
