package com.wjx.sjsr.dao.seckill;
...
@Mapper
public interface TestSeckillOrderDAO {
     ...
     * @return
     */
    TestSeckillOrder findById(@Param("seckillId") long seckillId, @Param("userPhone") long userPhone);
}
