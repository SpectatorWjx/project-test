...
public class BaseEntity implements Serializable {
    ...
    @GenericGenerator(name = "base-id", strategy = "com.wjx.sjsr.common.id_generator.IdGenerator")
    protected String id;
     ...
     */
    @JsonIgnore
    @Column(updatable = false, length = 50,columnDefinition="varchar(255) COMMENT '创建者'")
    @CreatedBy
     ...
     */
    @JsonIgnore
    @Column(length = 50,columnDefinition="varchar(255) COMMENT '更新人'")
    @LastModifiedBy
